...
def main() -> int:
    ...
    payload = {
        ...
        "rawCandidateCount": result.accounting.raw_candidate_count,
        "uniqueSpecificationCount": result.accounting.unique_specification_count,
        "independentFamilyCount": result.accounting.independent_family_count,
