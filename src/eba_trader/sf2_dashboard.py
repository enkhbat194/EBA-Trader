...
DEFAULT_SF2_STATUS_PATH = Path("/var/lib/eba-trader/research/sf2-development-latest.json")
DEFAULT_EVIDENCE_ROOT = Path("/var/lib/eba-trader/research/evidence")
STATUS_SCHEMA = "sf2_runtime_status_v1"
DEVELOPMENT_SCHEMA = "sf2_development_report_v1"
VALIDATION_SCHEMA = "sf2_validation_report_v1"
MAX_PUBLIC_CANDIDATES = 24
_BLOCKED_KEY_PARTS = (
    "apikey",
    "apisecret",
    "authorization",
...
def read_sf2_summary(
    *,
    ...
    configured_status = (
        status_path
        or os.getenv("EBA_SF2_STATUS", "").strip()
        or DEFAULT_SF2_STATUS_PATH
    )
    configured_evidence = (
        evidence_root
