...
`data_policy.py`; four outage-adjacent early-close timestamps are frozen there as well. Reports
disclose both. Any other gap or close-time anomaly remains a hard failure. The 2024 validation
